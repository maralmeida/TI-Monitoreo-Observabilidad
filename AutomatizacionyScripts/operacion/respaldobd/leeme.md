...
1- respaldo.py: Script automatizado que genera el archivo .bak, lo valida y lo mueve a una ubicación segura (File Server sugerido), resultado: 

2- restaura.py: Script de restauración de la base que gestiona la desconexión de usuarios, la restauración física y la sincronización de permisos de la aplicación (solución de usuarios huérfanos), resultado: 

3- SitioPruebas.bak: Artefacto de base de datos listo para ser desplegado (base portable). Resultado de restauración: 
